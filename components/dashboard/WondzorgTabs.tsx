      ...
      {isCaregiver && !canManagePlans && (
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 text-amber-800 text-sm">
          <div className="flex items-center gap-2">
            ...
            <span>U bent niet gemachtigd om wondzorgplannen te beheren voor deze cliënt. U kunt wel dagelijkse rapportages aanmaken via het tabblad Dagelijkse Rapportages.</span>
          </div>
        </div>
      )}
