...
import MedicationOverviewClient from "@/components/dashboard/MedicationOverviewClient"

export default async function MedicationOverviewPage() {
  ...
  return (
    <DashboardLayout userName={user.email} userRole={user.role} clients={clients}>
      <MedicationOverviewClient user={user} />
    </DashboardLayout>
  )
}
