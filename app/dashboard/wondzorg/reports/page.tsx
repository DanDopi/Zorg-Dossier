...
import WondzorgReportsListClient from "@/components/dashboard/WondzorgReportsListClient"

export default async function WondzorgReportsPage() {
  ...
  return (
    <DashboardLayout userName={user.email} userRole={user.role} clients={clients}>
      <WondzorgReportsListClient userRole={user.role} />
    </DashboardLayout>
  )
}
